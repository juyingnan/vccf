...
point_position_dict = {sun_type["S"]: 1.0,
                       ...
                       f'-{sun_type["S"]}': 1.0,
                       f'-{sun_type["N"]}': -0.9,
                       f'CD68-{sun_type["S"]}': 1.0,
                       f'CD68-{sun_type["N"]}': -0.8,
                       f'T-Helper-{sun_type["S"]}': 1.1,
                       f'T-Helper-{sun_type["N"]}': -0.9,
                       f'T-Reg-{sun_type["S"]}': 1.1,
                       f'T-Reg-{sun_type["N"]}': -0.9,
                       f'T-Killer-{sun_type["S"]}': 1.1,
                       f'T-Killer-{sun_type["N"]}': -0.95,

                       f'P53-{sun_type["S"]}': 0.8,
                       f'P53-{sun_type["N"]}': -0.8,
                       f'KI67-{sun_type["S"]}': 1.1,
                       f'KI67-{sun_type["N"]}': -0.7,
                       f'DDB2-{sun_type["S"]}': 0.8,
                       f'DDB2-{sun_type["N"]}': -0.8,
                       }
...
fig.update_yaxes(range=[-149, 1300])
